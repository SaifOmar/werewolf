...
let minuteRecord = document.getElementById("minutes");

minuteRecord.addEventListener('change', () => {
    TIME_LIMIT = parseInt(minuteRecord.value);
    resetTimer();
...
let TIME_LIMIT = parseInt(minuteRecord.value);
let timePassed = 0;
...
function startTimer() {
  ...
  document.getElementById('startTimer').onclick = resetTimer
}
...
function resetTimer() {
  ...
  document.getElementById('movement').addEventListener('click', ()=> location.href = "vote.html")